...
tellraw @s ["",{"text":"Commande utilie :","underlined":true},{"text":" /trigger help_blockProtec","color":"gold","clickEvent":{"action":"suggest_command","value":"/trigger help_blockProtec"},"hoverEvent":{"action":"show_text","contents":{"text":"Affiche l'aide (à tout moment)"}}},{"text":"\n"}]